...
int coordinates(const char* pixelInput, char* coordsOutput);
...
/*
int coordinates(const char* coordsInput, char* coordsOutput, char* positiveDirectory){

    std::fstream modifyPythonScript;
    std::ofstream copyPythonScript;

    modifyPythonScript.open("/Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader.py");
    copyPythonScript.open("/Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader_copy.py");
    ...
    std:: stringstream directoryInput1, directoryOutput2, directoryInput3;
    std::getline(modifyPythonScript, line);
    directoryInput1 << "    pixelCoords = '" << coordsInput << "'" << std::setw(80) << std::endl;
    copyPythonScript << directoryInput1.str();
    std::getline(modifyPythonScript, line);
    directoryOutput2 << "    realCoords = '" << coordsOutput << "'" << std::setw(80) << std::endl;
    copyPythonScript << directoryOutput2.str();
    std::getline(modifyPythonScript, line);
    directoryOutput3 << "    positiveDirectory = '" << positiveDirectory << "'" << std::setw(80) << std::endl;
    copyPythonScript << directoryOutput3.str();
    while(std::getline(modifyPythonScript, line)){
        copyPythonScript << line << std::endl;
    }
    copyPythonScript.close();
    modifyPythonScript.close();
    remove("/Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader.py");
    rename("/Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader_copy.py", "/Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader.py");

    system("cd && source tensorflow/bin/activate && cd /Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018 && python /Users/bound_to_love/Downloads/EcoCensus-master-01292018/CurrentImplementation01292018/imageReader.py");
