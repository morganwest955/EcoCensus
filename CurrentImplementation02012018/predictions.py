...
rootdir = os.path.dirname('/Users/bound_to_love/Downloads/T3/Partitions/')
directory = os.path.dirname('/Users/bound_to_love/Downloads/T3/')
...
for file in files:
    if ".JPG" in file:
        ...
        if miconia > .24:
            img.save(directory1+"/" + file)
        else:
            img.save(directory2+"/"+ file)
